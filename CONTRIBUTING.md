# Contributing to fao-soils

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
fao-soils. These guidelines are not strict rules.
...
The fao-soils team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the fao-soils technical leads
...
[issues]: https://github.com/bioepic-data/fao-soils/issues/
[pulls]: https://github.com/bioepic-data/fao-soils/pulls/
